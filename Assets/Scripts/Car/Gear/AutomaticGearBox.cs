...
namespace Car.Gear
{
    ...
    {
        private readonly Gear[] _gears = { Gear.Park, Gear.Reverse, Gear.Neutral, Gear.Drive };
        ...
        {
            _currentGearIndex++;
            if (_currentGearIndex > _gears.Length - 1) _currentGearIndex--;
        }

        public void DownShift()
        {
            _currentGearIndex--;
            if (_currentGearIndex < 0) _currentGearIndex++;
        }
